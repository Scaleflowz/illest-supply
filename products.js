...
const PRODUCTS = [
  {
    ...
    condition: "Brand New", isNewArrival: false, isBestSeller: true,
    viewers: 312,
    soldCount: 53, isSoldOut: false,
    badges: ["HOT"],
  ...
  },
  {
    ...
    price: 95, origPrice: 165, category: "sneakers", brand: "Prada",
    condition: "Brand New", isNewArrival: false, isBestSeller: false,
    viewers: 174,
    soldCount: 28, isSoldOut: false,
    badges: ["NEW"],
  ...
  },
  {
    ...
    condition: "Brand New", isNewArrival: true, isBestSeller: true,
    viewers: 289,
    soldCount: 47, isSoldOut: false,
    badges: ["NEW", "HOT"],
  ...
  },
  {
    ...
    condition: "Brand New", isNewArrival: true, isBestSeller: false,
    viewers: 247,
    soldCount: 39, isSoldOut: false,
    badges: ["NEW", "LOW"],

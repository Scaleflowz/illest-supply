...
function getNavHTML(activePage) {
  ...
  return `
  <div id="announcement" style="background:#ffffff;border-bottom:1px solid rgba(0,0,0,0.1);overflow:hidden;position:relative;height:36px;">
    <div style="display:flex;width:max-content;animation:announceTicker 18s linear infinite;">
      <span style="white-space:nowrap;padding:9px 40px;font-size:11px;font-weight:700;letter-spacing:0.25em;color:#000000;text-transform:uppercase;">DRESS DIFFERENT</span><span style="padding:9px 0;font-size:11px;color:#000000;">·</span><span style="white-space:nowrap;padding:9px 40px;font-size:11px;font-weight:700;letter-spacing:0.25em;color:#000000;text-transform:uppercase;">STAY ILLEST</span><span style="padding:9px 0;font-size:11px;color:#000000;">·</span><span style="white-space:nowrap;padding:9px 40px;font-size:11px;font-weight:700;letter-spacing:0.25em;color:#000000;text-transform:uppercase;">DRESS DIFFERENT</span><span style="padding:9px 0;font-size:11px;color:#000000;">·</span><span style="white-space:nowrap;padding:9px 40px;font-size:11px;font-weight:700;letter-spacing:0.25em;color:#000000;text-transform:uppercase;">STAY ILLEST</span><span style="padding:9px 0;font-size:11px;color:#000000;">·</span><span style="white-space:nowrap;padding:9px 40px;font-size:11px;font-weight:700;letter-spacing:0.25em;color:#000000;text-transform:uppercase;">DRESS DIFFERENT</span><span style="padding:9px 0;font-size:11px;color:#000000;">·</span><span style="white-space:nowrap;padding:9px 40px;font-size:11px;font-weight:700;letter-spacing:0.25em;color:#000000;text-transform:uppercase;">STAY ILLEST</span><span style="padding:9px 0;font-size:11px;color:#000000;">·</span>
    </div>
  </div>
  <nav>
